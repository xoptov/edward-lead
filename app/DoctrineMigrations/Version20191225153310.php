 ...
 */
final class Version20191225153310 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD logotype_id INT UNSIGNED DEFAULT NULL, ADD type VARCHAR(8) DEFAULT NULL, ADD personal_full_name VARCHAR(30) DEFAULT NULL, ADD personal_birth_date DATE DEFAULT NULL, CHANGE type_selected role_selected TINYINT(1) NOT NULL');
        ...
        $this->addSql('UPDATE user u, company c SET u.logotype_id = c.logotype_id WHERE u.id = c.user_id');
        ...
        $this->addSql('ALTER TABLE company DROP logotype_id, DROP office_name, DROP office_phone, DROP office_address, CHANGE short_name short_name VARCHAR(50) DEFAULT NULL, CHANGE large_name large_name VARCHAR(100) DEFAULT NULL, CHANGE inn inn VARCHAR(12) DEFAULT NULL, CHANGE ogrn ogrn VARCHAR(15) DEFAULT NULL, CHANGE bik bik VARCHAR(9) DEFAULT NULL, CHANGE account_number account_number VARCHAR(25) DEFAULT NULL, CHANGE address address VARCHAR(150) DEFAULT NULL, CHANGE zipcode zipcode VARCHAR(6) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP logotype_id, DROP type, DROP personal_full_name, DROP personal_birth_date, CHANGE role_selected type_selected TINYINT(1) NOT NULL');
    }
}
